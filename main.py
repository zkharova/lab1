...
f = open("steam_description_data.csv", encoding="latin-1")
...
head = len(' '.join(header_symb)) - (len(header_symb) - 1)
...
print("Количество символов в заголовках первого уровня:",head)
f.close()